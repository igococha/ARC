...
<run id="mcmc" spec="MCMC" chainLength="100000">
    <state id="state" spec="State" storeEvery="5000">
        ...
        <!-- branch rate model parameters -->
			<parameter spec='parameter.IntegerParameter' name="stateNode" id='rateCategories' dimension="11" value="1" />
			<parameter spec="parameter.RealParameter" name="stateNode" id='rateMean' value=".005" lower=".0001" upper="10.0"  />
			<parameter spec="parameter.RealParameter" name="stateNode" id='rateOmega' value=".5"  lower="0.1" upper="10"/>
    ...
    <distribution id="posterior" spec="util.CompoundDistribution">
        ...
        <distribution id="likelihood" spec="util.CompoundDistribution" useThreads="true">
            <distribution id="treeLikelihood.1" spec="ThreadedTreeLikelihood" data="@1" tree="@Tree.t:1">
				...
				<branchRateModel spec='beast.evolution.branchratemodel.ARClockModel' id="branchRates" numberOfDiscreteRates="12" 
				tree="@Tree.t:1" rateCategories='@rateCategories' rateMean='@rateMean' rateOmega='@rateOmega' numSites="--numsites--" />    	    
